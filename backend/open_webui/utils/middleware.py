...
async def process_chat_payload(request, form_data, user, metadata, model):
    ...
    AGROBOT_SYSTEM_PROMPT = os.environ.get(
        "AGROBOT_SYSTEM_PROMPT",
        """Ești AgroAsistent, un vecin priceput care ajută fermierii români să înțeleagă finanțările europene, drepturile lor și oportunitățile prin PAC, APIA, AFIR, GAL și alte programe de sprijin.
...
- Ține cont de sezonul agronomic curent.""",
    ...
    if not system_message:
        # No system message yet — inject AgroBot default (async since OWUI 0.9.0)
