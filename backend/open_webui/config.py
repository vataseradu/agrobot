...
PENDING_USER_OVERLAY_CONTENT = PersistentConfig(
    ...
    os.environ.get(
        'PENDING_USER_OVERLAY_CONTENT',
        'Contul dumneavoastră este în așteptarea aprobării administratorului. Veți putea utiliza AgroBot după aprobare.',
    ),
)
...
RAG_TOP_K = PersistentConfig('RAG_TOP_K', 'rag.top_k', int(os.environ.get('RAG_TOP_K', '5')))
...
CHUNK_SIZE = PersistentConfig('CHUNK_SIZE', 'rag.chunk_size', int(os.environ.get('CHUNK_SIZE', '1024')))
